...
namespace DotNet.Utilities
{
    ...
    public class ExcelHelper
    {
        ...
        public static bool OutputToExcel(DataTable Table, string ExcelFilePath)
        {
            ...
            {
                ShowException.ShowtheExceptionNoMessage("excelError", exp);
                throw exp;
            }
        ...
        /// <param name="ExcelFileName">Excel文件名</param>
        /// <param name="TableName">数据表名</param>
        public static DataTable MyGetExcelTableColumns(string ExcelFileName)
        {
            DataTable dt = new DataTable();
            ArrayList ColsList = new ArrayList();
            try
            {
                if (File.Exists(ExcelFileName))
                {
                    ...
                    {
                        conn.Open();
                        dt = conn.GetOleDbSchemaTable(OleDbSchemaGuid.Columns, new object[] { null, null, null, null });
            ...
            {
                ShowException.ShowtheExceptionNoMessage("ExcelError", e);
            }
            return dt;
        }
    }
