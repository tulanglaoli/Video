...
namespace DotNet.Utilities
{
    ...
    {
        public static void StringToDate(string TimeStr, out DateTime dt)
        {
            ...
            {
                dt = new DateTime();
                ShowException.ShowtheExceptionNoMessage("TimeException", new Exception(TimeStr + "时间转化失败"));
            }
        }
        ...
        public static DateTime Converttodatatime(string timestr)
        {

            return new DateTime(int.Parse(timestr.Substring(0, 4)), int.Parse(timestr.Substring(4, 2)), int.Parse(timestr.Substring(6, 2)));
        }
